classdef f5 < PROBLEM
    methods
        ...
        function PopObj = CalObj(obj, PopDec)
            ...
            term1_J1 = sum((PopDec(:, J1) - (0.3*x1.^2 .* cos(24*pi*x1 + 4*pi*(J1/n)) + 0.6*x1 .* cos(6*pi*x1 + pi*(J1/n)))).^2, 2);
            term2_J2 = sum((PopDec(:, J2) - (0.3*x1.^2 .* cos(24*pi*x1 + 4*pi*(J2/n)) + 0.6*x1 .* sin(6*pi*x1 + pi*(J2/n)))).^2, 2);
